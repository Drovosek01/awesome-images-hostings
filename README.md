...
Я постарался сократить заголовки стобцов до минимума так, чтобы они не потеряли смысла. Подробнее о значении заголовка, о том какая информация находится в каждом столбце рассказано ниже в пункте "Объяснение заголовков в таблице".
...
Эти сервисы не имею привычного для хостингов картинок интерфейса, поэтому сравнительная таблица для них, наверное, будет лишняя. Для каждого такого сервиса будет добавлено отедбное описание с информацией имеющей отношение к тематике репозитория.
